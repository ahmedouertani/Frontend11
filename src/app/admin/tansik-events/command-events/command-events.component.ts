...
@Component({
  selector: 'app-command-events',
  standalone: false,
  templateUrl: './command-events.component.html',
  styleUrl: './command-events.component.css'
})
export class CommandEventsComponent {
  orders: any[] = [];
  showSidebar = false;
  reservations: any[] = [];
  displayedColumns: string[] = ['trackingId','nomService','prix','userName','adresse','date','orderStatus','action'];
